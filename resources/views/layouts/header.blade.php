<header class="navbar navbar-dark navbar-expand flex-column flex-md-row bd-navbar">
    <div class="navbar-nav-scroll">
        <ul class="navbar-nav bd-navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('showFeedbackForm')}}">Обратная связь</a>
            </li>
        </ul>
    </div>
            ...
            <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="row col-md-12 text-center no-gutters">
                        ...
                        <form action="{{route('logout')}}" method="post"><button type="submit" class="dropdown-item col-md-9">Выход</button></form>
                    </div>
                </div>
            </div>
        @else
